...
step "checkbox Route requisitions to buyer if supplier is in draft status click that checkbox" do
  @setup.draft_supplier.set(true)
...
step "Enter itemname,supplier,prices,commodity" do
  @review.cartitem.itemname.set "mobile"
  @review.cartitem.supplier.set "cellkone"
