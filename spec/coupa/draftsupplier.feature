...
Background:I am opening the home page of coupa
 ...
 Scenario:Creating requisition to buyer with draft supplier       
...
Then checkbox Route requisitions to buyer if supplier is in draft status click that checkbox
